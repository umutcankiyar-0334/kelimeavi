/**
 * tr-words.ts
 * Curated Turkish word dictionary.
 * ~400 words across easy / medium / hard difficulty buckets.
 *
 * Schema: word, length, difficulty, frequency (1-1000), hasTurkishChars
 *
 * To replace with a larger dataset (e.g. TDK corpus):
 *   1. Prepare an array of WordEntry objects in the same shape.
 *   2. Run:  node scripts/seed-dictionary.mjs your-wordlist.txt
 *   3. The script will output a new tr-words.ts replacing this file.
 */
...
const words: WordEntry[] = [
  ...
  { word: "atom", length: 4, difficulty: "medium", frequency: 720, hasTurkishChars: false },
